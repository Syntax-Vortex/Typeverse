...
export function generateTimedSettings(){
    document.querySelector('.js-group-2').innerHTML = `
                <input class="radio-button" type="radio" name="duration" id="30" value="30" checked>
                <label class="radio-text" for="30">30s</label>

                <input class="radio-button" type="radio" name="duration" id="60" value="60">
                <label class="radio-text" for="60">60s</label>

                <input class="radio-button" type="radio" name="duration" id="120" value="120">
                <label class="radio-text" for="120">120s</label>

                <input class="radio-button" type="radio" name="duration" id="customDuration" value="customDuration">
...
export function generateWordsSettings(){
    document.querySelector('.js-group-2').innerHTML = `
                <input class="radio-button" type="radio" name="wordCount" id="25" value="25" checked>
                <label class="radio-text" for="25">25</label>

                <input class="radio-button" type="radio" name="wordCount" id="50" value="50">
                <label class="radio-text" for="50">50</label>

                <input class="radio-button" type="radio" name="wordCount" id="100" value="100">
                <label class="radio-text" for="100">100</label>

                <input class="radio-button" type="radio" name="wordCount" id="customWordCount" value="customWordCount">
